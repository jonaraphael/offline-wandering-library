...
The `flash-16gb` preset selects **436 pinned files totaling 9,696,060,616 bytes**, over six times the former selection. Its 1 GB published-search budget, 3 GB indexing workspace, 16 MiB metadata allowance and 1.5 GB free-space reserve bring the planned in-place peak to **15,212,837,832 bytes**. The 64 GB preset selects **450 files totaling 40,272,521,791 bytes**, with 4 GB search, 12 GB scratch and 6 GB reserve: **62,289,299,007 bytes** at the planning peak. These exact small presets contain only resolved files; individual broader collection scopes can still be partial. Optional caches and retained old generations need additional space. Nothing is padded merely to fill a drive.
